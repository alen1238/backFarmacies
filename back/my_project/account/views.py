...
from .serializers import ModelSerializer, BillingAddressSerializer, AllOrdersListSerializer, UserSerializer, UserRegisterTokenSerializer
...
class CardsListView(APIView):
    ...
    def get(self, request):
        ...
        serializer = ModelSerializer(cards, many = True)
        return Response(serializer.data, status=status.HTTP_200_OK)
