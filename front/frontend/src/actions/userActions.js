...
export const getAllAddress = () => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.get("/account/all_address/", config);
...
export const getSingleAddress = (id) => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.get(`/account/address-details/${id}/`, config);
...
export const getAllOrders = () => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.get(`/account/all_orders/`, config);
